...
public class ItemListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null || savedInstanceState.getParcelableArray(key) == null) {
            ...
            bindService(listLoaderIntent, serviceConnection, BIND_AUTO_CREATE);
            startService(listLoaderIntent);
        } else {
            thiss.data = (ImageData[]) savedInstanceState.getParcelableArray(key);
            recyclerView = findViewById(R.id.item_list);
            setupRecyclerView(recyclerView);
        }
    }
